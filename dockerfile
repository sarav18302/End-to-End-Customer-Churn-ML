...
ARG ID="3b1a41221fc44548aed629fa42b762e0"
# Copy MLflow run (artifacts + metadata) to the flat /app/model convenience path
COPY src/serving/model/${ID}/artifacts/model /app/model
COPY src/serving/model/${ID}/artifacts/feature_columns.txt /app/model/feature_columns.txt
COPY src/serving/model/${ID}/artifacts/preprocessing.pkl /app/model/preprocessing.pkl
